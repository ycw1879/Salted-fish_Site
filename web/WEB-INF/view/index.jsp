...
<%--									<img src="/resources/img/j01.jpg" alt="image01">--%>
								...
								<div class="li-txt">
									<p class="li-name"><%= bestProduct.getProductTitle() %>
									</p>
									<p class="li-price"><%= StringUtil.formatNumber(bestProduct.getPrice()) %><b>&nbsp;원</b>
									</p>
									<p class="li-icon"></p>
...
<%--									<img src="/resources/img/j01.jpg" alt="image01">--%>
								...
								<div class="li-txt">
									<p class="li-name"><%= newProduct.getProductTitle() %>
									</p>
									<p class="li-price"><%= StringUtil.formatNumber(newProduct.getPrice()) %><b>&nbsp;원</b>
									</p>
									<p class="li-icon"></p>
									<a href="/product/view/<%= newProduct.getSeq() %>"></a>
								</div>
